...
Spec only in this repo - see the note in `AGENT.md` on why live credentials aren't wired up here, and see [`release-notes-agent`](../../launch-and-growth/release-notes-agent) for a fully runnable example of the same agent pattern.
