...
This is an illustrative example of how a session with `prd-builder` unfolds — not a real product's PRD. It shows the section-by-section behavior described in the skill.

---

**PM:** I want to add a feature where supervisors can see which of their agents are struggling in real time.

**prd-builder:** Let's start with the Problem Statement before anything else. A few questions to sharpen it:
...
**prd-builder:** Drafting the Problem Statement:
